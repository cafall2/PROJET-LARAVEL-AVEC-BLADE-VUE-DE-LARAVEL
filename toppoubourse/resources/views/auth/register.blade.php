...
<div class="container" style="margin-top: 100px; margin-bottom: 20px">
    <div class="row justify-content-center">
        <div class="col-md-8">
         ...
         <div class="row mb-3">
                            <label for="UFR" class="col-md-4 col-form-label text-md-end">{{ __('UFR') }}</label>

                            <div class="col-md-6">
                                <input id="UFR" type="text" class="form-control @error('UFR') is-invalid @enderror" name="UFR" value="{{ old('UFR') }}" required autocomplete="UFR" autofocus>
